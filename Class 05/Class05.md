...
Lets make the same plot with these two graphics systems. We can use the
...
> **N.B.** We newver run on an ‘install.packages()’ in a code chunk
...
Every ggplot needs at least 3 things: 1. The **data** i.e. stuff to plot
as a data.frame 2. The **aes** or aesthetics that map the data to the
